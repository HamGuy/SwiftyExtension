...
#elseif canImport(AppKit)
    func setRangeFontText(font: NSFont, range: NSRange) -> NSAttributedString {
        return setSpecificRangeTextMoreAttributes(attributes: [NSAttributedString.Key.font : font], range: range)
    }
#endif
...
#elseif canImport(AppKit)
    func setSpecificTextFont(_ text: String, font: NSFont) -> NSAttributedString {
        return setSpecificTextMoreAttributes(text, attributes: [NSAttributedString.Key.font : font])
    }
#endif
...
#elseif canImport(AppKit)
    func setSpecificRangeTextColor(color: NSColor, range: NSRange) -> NSAttributedString {
        return setSpecificRangeTextMoreAttributes(attributes: [NSAttributedString.Key.foregroundColor : color], range: range)
    }
#endif
...
#elseif canImport(AppKit)
    func setSpecificTextColor(_ text: String, color: NSColor) -> NSAttributedString {
        return setSpecificTextMoreAttributes(text, attributes: [NSAttributedString.Key.foregroundColor : color])
    }
#endif
...
#elseif canImport(AppKit)
    func setSpecificRangeUnderLine(color: NSColor, stytle: NSUnderlineStyle = .single, range: NSRange) -> NSAttributedString {
        // 下划线样式
        let lineStytle = NSNumber(value: Int8(stytle.rawValue))
        return setSpecificRangeTextMoreAttributes(attributes: [NSAttributedString.Key.underlineStyle: lineStytle, NSAttributedString.Key.underlineColor: color], range: range)
    }
...
#elseif canImport(AppKit)
    func setSpecificTextUnderLine(_ text: String, color: NSColor, stytle: NSUnderlineStyle = .single) -> NSAttributedString {
        // 下划线样式
        let lineStytle = NSNumber(value: Int8(stytle.rawValue))
        return setSpecificTextMoreAttributes(text, attributes: [NSAttributedString.Key.underlineStyle : lineStytle, NSAttributedString.Key.underlineColor: color])
    }
...
#elseif canImport(AppKit)
    func setSpecificRangeDeleteLine(color: NSColor, range: NSRange) -> NSAttributedString {
        var attributes = Dictionary<NSAttributedString.Key, Any>()
        // 删除线样式
        let lineStytle = NSNumber(value: Int8(NSUnderlineStyle.single.rawValue))
        attributes[NSAttributedString.Key.strikethroughStyle] = lineStytle
...
#elseif canImport(AppKit)
    func setSpecificTextDeleteLine(_ text: String, color: NSColor) -> NSAttributedString {
        var attributes = Dictionary<NSAttributedString.Key, Any>()
        // 删除线样式
        let lineStytle = NSNumber(value: Int8(NSUnderlineStyle.single.rawValue))
        attributes[NSAttributedString.Key.strikethroughStyle] = lineStytle
...
#elseif canImport(AppKit)
    private func loadImage(imageName: String) -> NSImage? {
        if imageName.hasPrefix("http://") || imageName.hasPrefix("https://") {
            let imageURL = URL(string: imageName)
            var imageData: Data? = nil
            do {
...
public extension JKPOP where Base: NSAttributedString {
    ...
    /// - Returns: 富文本的宽度
    func widthOfAttributedString(size: CGSize, options: NSString.DrawingOptions = [.usesLineFragmentOrigin, .usesFontLeading]) -> CGFloat {
    ...
    ///   - options: options description
    /// - Returns: 富文本的高度
    func heightOfAttributedString(size: CGSize, options: NSString.DrawingOptions = [.usesLineFragmentOrigin, .usesFontLeading]) -> CGFloat {
    ...
    ///   - options: options description
    /// - Returns: 富文本的size
    func sizeOfAttributedString(size: CGSize, options: NSString.DrawingOptions = [.usesLineFragmentOrigin, .usesFontLeading]) -> CGSize {
