...
public class JKTapActionLabel: NSTextView {
    ...
    public override func touchesBegan(with event: NSEvent) {
        ...
        let index = self.layoutManager!.characterIndex(for: location, in: textContainer, fractionOfDistanceBetweenInsertionPoints: nil)
